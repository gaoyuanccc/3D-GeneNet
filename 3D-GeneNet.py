...
def parse_args():
    ...
    parser.add_argument('-n',"--n_bootstrap", type=int, default=None, help="Number of bootstrap iterations.")
...
def main():
    ...
    if args.multichromosome == 0: #如果不是多染色体
        ...
        if args.n_bootstrap is None:
            args.n_bootstrap = round(len(gene_interaction_distance_intra_asc.keys()) * 0.8)
